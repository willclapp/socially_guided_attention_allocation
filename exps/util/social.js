const questionnaire = {
  ...
  pages: [
    [
      ...
      {
        type: 'drop-down',
        prompt: "In the final part of the experiment, when you couldn't understand a sentence, how did you generally respond?",
        name: 'strategy',
        options: ['Respond OLD', 'Respond NEW', 'Choose randomly between OLD and NEW','Prefer not to say'],
        required: true
      },
      {
        type: 'text',
        prompt: "In the final part of the experiment, how easy or difficult did you find it to understand the sentences? Did you notice any patterns with sentences you could or could not understand?",
